...
public class PhoneNumberActivity extends AppCompatActivity {
    ...
    private EditText phoneTextBx;
    private EditText countryCodeTxtbx;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        phoneTextBx = findViewById(R.id.phoneTxtBx);
        countryCodeTxtbx = findViewById(R.id.cCodeTxtBx);
        ...
        View.OnClickListener nextClickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String phoneNumber = "+" + countryCodeTxtbx.getText().toString().trim() + phoneTextBx.getText().toString().trim();

                PhoneAuthProvider.getInstance().verifyPhoneNumber(phoneNumber, 60,
                        TimeUnit.SECONDS, activity, new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                            ...
                            public void onVerificationCompleted(PhoneAuthCredential credential) {
                                ...
                                mAuth.signInWithCredential(credential).addOnCompleteListener(
                                        PhoneNumberActivity.this, new OnCompleteListener<AuthResult>() {
                                            @Override
                            ...
                            public void onCodeSent(String verificationId,
                                ...
                                SessionVariables.PhoneVerificationId = verificationId;
                                SessionVariables.PhoneResendToken = token;
